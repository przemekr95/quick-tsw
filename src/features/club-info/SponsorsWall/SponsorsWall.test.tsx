...
const sponsors: Sponsor[] = [
  { name: 'Sponsor A', tier: 1, logoSrc: '/images/sponsors/k/msit.png', websiteUrl: 'https://example.com/a' },
  { name: 'Sponsor B', tier: 2, logoSrc: '/images/sponsors/k/klub.png', websiteUrl: 'https://example.com/b' },
  { name: 'Sponsor C', tier: 2, logoSrc: '/images/sponsors/k/pzps.png', websiteUrl: 'https://example.com/c' },
  { name: 'Sponsor D', tier: 3, logoSrc: '/images/sponsors/k/mzps.png', websiteUrl: 'https://example.com/d' },
];
...
describe('SponsorsWall', () => {
  ...
  it('returns null when sponsor names are empty after normalization', () => {
    render(<SponsorsWall sponsors={[{ name: '[]', tier: 1 }, { name: '   ', tier: 2 }]} />);
